...
export const WORKER_GET_ACTIVE_KEY_BY_BRAINKEY = 1;
export const WORKER_GET_SOCIAL_KEY_BY_ACTIVE_KEY = 2;
export const WORKER_GET_PUBLIC_KEY_BY_PRIVATE_KEY = 3;
export const WORKER_BIND_SOCIAL_KEY_WITH_SOCIAL_PERMISSIONS = 4;
export const WORKER_ADD_SOCIAL_PERMISSIONS_TO_EMISSION_AND_PROFILE = 5;
export const WORKER_ECC_SIGN = 6;
export const WORKER_GET_UPVOTE_CONTENT_SIGNED_TRANSACTION = 7;
export const WORKER_GET_DOWNVOTE_CONTENT_SIGNED_TRANSACTION = 8;
export const WORKER_GET_FOLLOW_ACCOUNT_SIGNED_TRANSACTION = 9;
export const WORKER_GET_UNFOLLOW_ACCOUNT_SIGNED_TRANSACTION = 10;
export const WORKER_GET_FOLLOW_ORGANIZATION_SIGNED_TRANSACTION = 11;
export const WORKER_GET_UNFOLLOW_ORGANIZATION_SIGNED_TRANSACTION = 12;
export const WORKER_GET_TRUST_USER_SIGNED_TRANSACTIONS_AS_JSON = 13;
export const WORKER_GET_UNTRUST_USER_SIGNED_TRANSACTIONS_AS_JSON = 14;
export const WORKER_SIGN_CREATE_PUBLICATION_FROM_ORGANIZATION = 15;
export const WORKER_SIGN_CREATE_PUBLICATION_FROM_USER = 16;
export const WORKER_SIGN_UPDATE_PUBLICATION_FROM_ORGANIZATION = 17;
export const WORKER_SIGN_UPDATE_PUBLICATION_FROM_USER = 18;
export const WORKER_SIGN_CREATE_DIRECT_POST_FOR_ACCOUNT = 19;
export const WORKER_SIGN_CREATE_DIRECT_POST_FOR_ORGANIZATION = 20;
export const WORKER_SIGN_UPDATE_DIRECT_POST_FOR_ACCOUNT = 21;
export const WORKER_SIGN_UPDATE_DIRECT_POST_FOR_ORGANIZATION = 22;
export const WORKER_SIGN_CREATE_REPOST_POST_FOR_ACCOUNT = 23;
export const WORKER_SIGN_CREATE_COMMENT_FROM_ORGANIZATION = 24;
export const WORKER_SIGN_CREATE_COMMENT_FROM_USER = 25;
export const WORKER_UPDATE_PROFILE = 26;
export const WORKER_SIGN_CREATE_ORGANIZATION = 27;
export const WORKER_SIGN_UPDATE_ORGANIZATION = 28;
